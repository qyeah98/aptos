...
echo -e "\e[1m\e[32m1.1 Set Validator Name \e[0m" && sleep 1
read -p "INPUT Validator Name: " VALIDATOR_NAME

echo "=================================================="

echo -e "\e[1m\e[32m1.2 Set USERNAME \e[0m" && sleep 1
read -p "INPUT Username: " USERNAME

echo "=================================================="

echo -e "\e[1m\e[32m1.3 Set Project ID \e[0m" && sleep 1
read -p "INPUT Project ID: " PROJECT_ID

echo "=================================================="
echo -e "\e[1m\e[32m1.4 Set Google Cloud Region \e[0m" && sleep 1
read -p "INPUT Region: " REGION

echo "=================================================="
echo -e "\e[1m\e[32m1.5 Set Google Cloud Zone \e[0m" && sleep 1
read -p "INPUT Zone: " ZONE

echo "=================================================="
echo -e "\e[1m\e[32m1.6 Set Google Cloud Storage \e[0m" && sleep 1
read -p "INPUT Bucket Name: " BUCKET

echo "=================================================="

echo -e "\e[1m\e[32m1.7 Set Workspace Name \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m2. Creating Terraform configuration... \e[0m" && sleep 1

echo -e "\e[1m\e[32m2.1 Creating Workspace... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m3. Terraform init and apply... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m4. Getting address... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m5. Creating Aptos Validator config files... \e[0m" && sleep 1

echo -e "\e[1m\e[32m5.1 Generate key pairs... \e[0m" && sleep 1

aptos genesis generate-keys --output-dir ~/$WORKSPACE

echo -e "\e[1m\e[32m5.2 Generate validator/fullnode config file... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m5.3 Creating YAML file... \e[0m" && sleep 1
...
echo -e "\e[1m\e[32m5.4 Downloading AptosFramework Move bytecode... \e[0m" && sleep 1
wget https://github.com/aptos-labs/aptos-core/releases/download/aptos-framework-v0.1.0/framework.zip
unzip framework.zip

echo -e "\e[1m\e[32m5.5 Compiling genesis blob and waypoint.... \e[0m" && sleep 1
aptos genesis generate-genesis --local-repository-dir ~/$WORKSPACE --output-dir ~/$WORKSPACE

echo "=================================================="

echo -e "\e[1m\e[32m6. Inserting genesis.blob, waypoint.txt and identity files... \e[0m" && sleep 1
